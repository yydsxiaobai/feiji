...
const UUID = process.env.UUID || '5efabea5-f6d5-88fd-b8f0-17e005c89c60'; // 运行哪吒v1,在不同的平台需要改UUID,否则会被覆盖
...
const SUB_PATH = process.env.SUB_PATH || 'feiji';            // 获取节点的订阅路径
const NAME = process.env.NAME || 'by xiaobai free';                       // 节点名称
